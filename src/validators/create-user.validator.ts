    ...
    static get rules(): Record<string, ValidationChain[]> {
        return {
            ...
            email: ValidationBuilder.ForField("email")
                ...
                .build(),
            mobileNumber: ValidationBuilder.ForField("mobileNumber").MinCharacters(7, { fieldDisplayName: "Mobile number" })
                .MaxCharacters(10, { fieldDisplayName: "Mobile number" })
                .build(),
            dob: ValidationBuilder.ForField("dob").IsDate({ fieldDisplayName: "Date of birth" }).build(),
